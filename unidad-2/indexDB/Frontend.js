class ApplicationView
{
    ...
    showMenuMain()
    {
        ...
        {
            case '1':
                this.handleLoginAttempts(this.showMenuMain.bind(this));
                break;
            case 'x':
                // salir, no hacer nada
                break;
    ...
    showUserRoleMenu(callback)
	{
        this._api.isValidUserGetData(this._username, function(user) {
            if (!user) 
            {
    ...
    handleLoginAttempts(callback) 
    {
        ...
        while (this._api_return.result === 'USER_PASSWORD_FAILED' && this._attempts < this._maxLoginFailedAttempts) 
        {
            ...
            this._api_return = this.loginResult.api_return;
            this._username = this.loginResult.username;
        ...
        {
            this.showUserRoleMenu(callback);
        }
    }
